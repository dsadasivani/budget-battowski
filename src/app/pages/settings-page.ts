    ...
    <section class="page narrow">
      ...
      <section class="utility-grid">
        <article class="panel-card action-card">
          <span class="icon-chip blue"><mat-icon aria-hidden="true">{{ store.statusIcon() }}</mat-icon></span>
          <h2>Sync Status</h2>
        ...
        <article class="panel-card action-card">
          <span class="icon-chip green"><mat-icon aria-hidden="true">account_circle</mat-icon></span>
          <h2>Account</h2>

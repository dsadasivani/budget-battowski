      ...
      <section class="page mobile-investments-page">
        ...
        <section class="content-grid two-one">
          <article class="panel-card mobile-portfolio-panel">
            ...
            <div class="data-table-wrap" tabindex="0" aria-label="Investment portfolio table">
                ...
                <tbody>
                  @for (investment of filteredRows(); track investment.id) {
                    <tr>
                      ...
                      <td>
                        <span class="badge neutral">{{ investment.categoryName }}</span>
                      </td>
                      <td>
                      ...
                      <td>
                        {{
                          investment.totalInvested | currency: 'INR' : 'symbol' : '1.0-0' : 'en-IN'
                        }}
                      </td>
                      <td>
                        <span class="badge success">{{
                          store.investmentFrequencyLabel(investment)
                        }}</span>
                      </td>
                      <td>
                        <button
...
export class InvestmentsPage {
  ...
  readonly filteredRows = computed(() => {
    ...
    return this.store
      .portfolioRows()
      .filter((investment) =>
        [investment.name, investment.categoryName].join(' ').toLowerCase().includes(query),
      );
  });
